...
const STATS = [
  {
    id: "candidatos",
    value: "Acceso",
    label: "A candidatos calificados",
  },
  {
    id: "horario",
    value: "100% gratuito",
    label: "Sin costo de participación",
  },
  {
    id: "marca",
    value: "Posicionamiento",
    label: "En el mercado de talento",
  },
];
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-4">
              ...
              <h1 className="text-4xl font-medium tracking-tight md:text-5xl text-navy">   
                Encuentre el{" "}
                <span className="text-primary">talento</span> que su organización necesita
              </h1>
              <p className="text-muted-foreground text-base md:text-lg">
                Completa el formulario de inscripción y se parte de la feria de empleo más grande del país. Publique sus vacantes y conéctese con estudiantes y profesionales listos para crecer.
              </p>
            </div>
