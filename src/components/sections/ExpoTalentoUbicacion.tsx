...
const DETALLES = [
  {
    id: "fecha",
    icon: Calendar,
    title: `${proximoEvento.diaSemana} ${proximoEvento.fecha}`,
    subtitle: proximoEvento.entrada,
  },
  {
    id: "horario",
    icon: Clock,
    title: proximoEvento.horario,
    subtitle: proximoEvento.horarioNota,
  },
  {
    id: "lugar",
    icon: MapPin,
    title: proximoEvento.institucion,
    subtitle: proximoEvento.sede,
  },
];

const MAPS_EMBED_SRC =
  "https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d4832.711726924088!2d-84.64013292496246!3d10.470251989660488!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTDCsDI4JzEyLjkiTiA4NMKwMzgnMTUuMiJX!5e1!3m2!1ses!2scl!4v1788868723826!5m2!1ses!2scl";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              <Badge className="text-sm h-auto py-1 px-3 border-0 w-fit gap-2 bg-secondary text-navy">
                ...
                Ubicación · {proximoEvento.nombre}
              </Badge>
            ...
            <div className="flex flex-col gap-5 rounded-2xl border border-border border-l-4 border-l-primary bg-white p-6 shadow-md">
          ...
          <div className="overflow-hidden rounded-2xl border border-border shadow-md">
            <iframe
              ...
              title={`Ubicación ${proximoEvento.nombre} - ${proximoEvento.institucion} ${proximoEvento.sede}`}
            />
          </div>
        </div>
      </div>
